...
// Colors
const RED  = '#AC936E'; // formerly "red" triangles
const BLUE = '#FF48B0'; // formerly "blue" triangles
const BG   = '#245E55';

// Per-slot direction: true = left "<", false = right ">"
const DIR_LEFT = [false, false, false, false, false, false];

// Per-slot color: true = blue, false = red
const IS_BLUE = [false, true, false, true, true, false];
...
function setup() {
  createCanvas(windowWidth, windowHeight); /* windowHeight/3*2 */ 
  noStroke();
